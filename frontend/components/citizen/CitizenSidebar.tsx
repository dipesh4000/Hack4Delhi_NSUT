...
import { LayoutDashboard, MapPin, Bell, Settings, LogOut, HelpCircle, MessageSquarePlus, MessageSquare, LogIn, Heart, Coins, Mail, Waves } from "lucide-react";
...
const MENU_ITEMS = [
  ...
  { icon: Waves, label: "Waterlogging", href: "/citizen/waterlogging" },
